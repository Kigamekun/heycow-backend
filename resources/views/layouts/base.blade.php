    ...
    <div id="app">
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex gap-3 " style="align-items: center">
                            <img src="{{ url('assets/static/images/logo/logo.png') }}" style="width: 40px;height:33px;"
                                alt="Logo">
                            <h4 class="text-primary fw-bold mt-2"
                                style="margin:5px 0px 0px 0px !important; color:#20A577 !important">HeyCow</h4>
                        </div>
                ...
                <center>
                    <div class="mt-3 mb-3" style="border: 1px solid #EDF2F4;width:80%;padding:10px;border-radius:10px;">
                        Reksa's Farm
                    </div>
                    <div style="height: 5px">
                    </div>
                    <hr style="opacity: .2;width:80%">
                </center>
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ Request::is('cattle*') ? 'active' : '' }}">
                            <a href="{{ route('cattle.index') }}" class='sidebar-link'>
                                <i class="fa-solid fa-cow"></i>
                                <span>Cattle</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{ Request::is('iotdevice*') ? 'active' : '' }}">
                            <a href="{{ route('iotdevice.index') }}" class='sidebar-link'>
        ...
        function confirmDelete(event) {
            ...
            if (form !== null) {
                Swal.fire({
                    ...
                    timer: 5000, // Optional: Auto-close the toast after 5 seconds
                    showConfirmButton: true, // Option to show buttons
                    timerProgressBar: true // Add progress bar to timer
                }).then((result) => {
    ...
    @if (!is_null(Session::get('message')))
        <script>
            Swal.fire({
                ...
                toast: true, // Enable toast style
                position: 'top-end', // Position the toast in the top right
