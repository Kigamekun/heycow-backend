                ...
                <form action="{{ route('cattle.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control {{ $errors->has('birth_date') ? 'is-invalid' : '' }}"
                        ...
                        <div class="mb-3">
                            <label for="iot_device_id" class="fw-semibold">IoT Device <span
                                    class="text-danger">*</span></label>
...
@section('js')
    ...
    <script>
        ...
        $('#updateCattle').on('shown.bs.modal', function(e) {
            ...
            var iotDevices = @json($iot_devices);
            iotDevices.forEach(function(device) {
                var isSelected = device.id == selectedIoTDeviceId ? 'selected' : '';
                iotDeviceOptions +=
                    `<option value="${device.id}" ${isSelected}>${device.serial_number}</option>`;
            });
            var farmId = $(e.relatedTarget).data('farm_id');
            var farmName = '';
            ...
            var html = `
                ...
                <form action="${$(e.relatedTarget).data('url')}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="breed" class="fw-semibold">Breed<span class="ml-1 text-danger">*</span></label>
