...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('blog')->group(function () {
        ...
        Route::patch('/publish/{id}', [BlogPostController::class, 'publish'])->name('blog.publish');
        Route::patch('/unpublish/{id}', [BlogPostController::class, 'unpublish'])->name('blog.unpublish');
